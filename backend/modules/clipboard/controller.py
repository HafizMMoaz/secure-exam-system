...
from modules.clipboard.service import record_event, get_summary, get_risk_data, get_health
...
def risk_data():
    ...
    return risk_data_response(module_name=ModuleName.CLIPBOARD.value, data=data)
